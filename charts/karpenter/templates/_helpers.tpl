...
*/}}
{{- define "karpenter.fullimage" -}}
{{- $tag := printf "v%s" .Chart.AppVersion }}
{{- .Values.controller.image.repository -}}:{{- .Values.controller.image.tag | default $tag -}}
{{- end }}

{{/*
Set ClusterID as required
*/}}
{{- define "karpenter.controller.settings.clusterID" -}}
{{- $ControllerSettingsClusterID := .Values.controller.settings.clusterID | required ".Values.controller.settings.clusterID is required." -}}
{{- $ControllerSettingsClusterID -}}
{{- end }}
